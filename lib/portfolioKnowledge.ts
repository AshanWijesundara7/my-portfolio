...
// ─── Auto-synced with your portfolio data ─────────────────────────────────────
// Projects are imported DIRECTLY from components/projects.tsx
// So whenever you add/edit a project there, the chatbot auto-updates. ✅
...
export const portfolioData = {
  ...
  // ✅ Update this path whenever you upload a new resume to /public
  ...
  // ✅ Projects are pulled live from components/projects.tsx — no manual update needed!
  get projects() {
    return projects
  },
}
...
export const intents: Intent[] = [
  ...
  // All projects — auto-generated from projects.tsx ✅
  {
  ...
  // Individual project lookup — dynamically matches ANY project by title/tag ✅
  {
    patterns: portfolioData.projects.flatMap(p => [
      p.title.toLowerCase(),
      p.slug,
      ...p.tags.map(t => t.toLowerCase()),
    ]),
    response: () => {
      // This is handled dynamically in chatEngine.ts via findProject()
      return ""
    },
  },
