        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center w-full">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-full border border-foreground transition-all duration-300 hover:bg-foreground hover:text-background"
      ...
      >
        <div className="px-6 py-6 space-y-4 max-w-7xl mx-auto">
          ...
          <a
            ...
            download
            onClick={handleNavClick}
            className="block mt-4 w-full bg-foreground text-background px-6 py-3 rounded-lg font-sans text-sm font-semibold uppercase tracking-wide text-center hover:bg-background hover:text-foreground hover:border hover:border-foreground transition-all duration-300"
          >
            Download CV
          </a>
        </div>
